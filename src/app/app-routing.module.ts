      ...
      children: [
        {
          path: 'proyectos',
          loadComponent: () =>
            import('./inscripcion/proyectos/proyectos.page').then(m => m.ProyectosPage),
        },
        {
          path: 'inscripcion-proyecto/:id',
          loadComponent: () =>
            import('./inscripcion/inscripcion-proyecto/inscripcion-proyecto.component').then(
              m => m.InscripcionProyectoComponent
            ),
        },
      ],
    },
